...
class MonitoringScheduleTest < ActiveSupport::TestCase
  test "create schedule" do
    monitoring_schedule = MonitoringSchedule.new(employees: employees, shifts: shifts)
    monitoring_schedule.create
    monitoring_schedule.print_schedule
    assert(true)
  end

  test "ORTools::BasicScheduler custom example" do
    scheduler = BasicScheduler.new(people: employees, shifts: shifts)
    ...
    puts "\nAssigned Hours: #{scheduler.assigned_hours}"
    puts "\nTotal Hours: #{scheduler.total_hours}"

    assert(true)
  end

  test "ORTools::BasicScheduler original example" do
    people = [
      {
